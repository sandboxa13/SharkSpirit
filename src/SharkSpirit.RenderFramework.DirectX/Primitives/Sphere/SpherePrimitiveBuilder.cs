...
namespace SharkSpirit.RenderFramework.DirectX.Primitives.Sphere
{
    public class SpherePrimitiveBuilder : AbstractPrimitiveBuilder
    {
        ...
        public Sphere Build(Sphere sphere)
        {
            ...
            var model = importer.ImportFile("C:\\Repositories\\BitBucket\\sharkspirit\\src\\SharkSpirit.Graphics\\sponza\\spheres.obj", PostProcessPreset.TargetRealTimeMaximumQuality);
        ...
        {
            renderObject.AddStage(new PixelConstantBufferStage<ConstantColor>(Device));
        }
