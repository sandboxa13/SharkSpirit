...
#define LOG_INIT_COUT() logger log(std::cout, __FUNCTION__)
#define LOG_INIT_CERR() logger log(std::cerr, __FUNCTION__)
#define LOG_INIT_CLOG() logger log(std::clog, __FUNCTION__)
#define LOG_INIT_CUSTOM(X) logger log((X), __FUNCTION__)
